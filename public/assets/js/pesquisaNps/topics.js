...
const fieldNameTopicsModal = document.getElementsByName('name')[0]
const fieldStatusTopicsModal = document.getElementsByName('status')[0]
...
function callModalRegisterTopic() {
  ...
  if (fieldNameTopicsModal.value.length > 0) {
...
async function listenClickUpdate() {
  ...
  spans.forEach(span => {
    span.addEventListener('click', (event) => {
      ...
      let statusIconClicked = span.querySelector('.bi-pencil').dataset.status

      fieldNameTopicsModal.value = nameIconClicked
